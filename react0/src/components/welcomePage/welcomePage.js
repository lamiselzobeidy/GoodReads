    ...
    return (
      <div className="WelcomePage">
            ...
            <Navbar.Text className="navlink" href="#home">
              <Navbar.Brand href="#home">
                ...
                <span className="navbarSpan">
                  good
                  <span className="navbarSpan" style={{ fontWeight: "bolder" }}>
                    reads
                  </span>
                </span>
              </Navbar.Brand>
        ...
        <div className="containerr mx-0 px-0 row w-100 mt-0">
          ...
          <div
            className="col-5 h-100 pt-3"
            style={{ backgroundColor: "rgba(23, 23, 24, 0.24)" }}
          >
            {/* <Form className="form py-3 px-4 w-75" noValidate onSubmit={this.onSubmit}>
                        ...
                        <div className="signinIcons px-4 pt-2 mt-2 w-75">
                            ...
                            <br/>
                            <div><a href="Registration ">3omar</a></div>
                        </div> */}
            ...
            <Tabs
              ...
              style={{ width: "40%", border: "transparent", paddingBottom:"7%",marginLeft:'18%' }}
            >
